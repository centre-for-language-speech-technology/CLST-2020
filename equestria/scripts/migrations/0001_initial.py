    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('folder', models.FilePathField(allow_files=False, allow_folders=True, path='C:\\Users\\Valentijn Albertus\\Documents\\School\\Software Engineering\\CLST-2020\\equestria\\userdata')),
                ('script', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='scripts.Script')),
            ],
            options={
