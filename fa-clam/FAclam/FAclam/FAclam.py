...
PROFILES = [
    Profile(
        ...
        #),
        InputTemplate('wav-file', WaveAudioFormat, "Audio file",
            extension='.wav',
            unique=True
        ),
        InputTemplate('text-file', PlainTextFormat, "TextGrid file",
...
#
COMMAND = WEBSERVICEDIR + "/FAclam_wrapper.py $DATAFILE $STATUSFILE $OUTPUTDIRECTORY"
