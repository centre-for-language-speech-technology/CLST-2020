...
CLAMDIR = clam.__path__[
    0
]  # directory where CLAM is installed, detected automatically
WEBSERVICEDIR = os.path.dirname(
    os.path.abspath(__file__)
)  # directory where this webservice is installed, detected automatically
...
SYSTEM_NAME = "CLAM FA server"

# An informative description for this system (this should be fairly short, about one paragraph, and may not contain HTML)
SYSTEM_DESCRIPTION = "CLAM server for running the Forced Alignment script"
...
#
COMMAND = (
    WEBSERVICEDIR + "/FAclam_wrapper.py $DATAFILE $STATUSFILE $OUTPUTDIRECTORY"
)

# Or for the shell variant:
# COMMAND = WEBSERVICEDIR + "/FAclam_wrapper.sh $STATUSFILE $INPUTDIRECTORY $OUTPUTDIRECTORY $PARAMETERS"
