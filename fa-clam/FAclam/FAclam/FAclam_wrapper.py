...
os.mkdir(os.path.join(outputdir, 'test-dir'))

for inputfile in clamdata.input:
   inputtemplate = inputfile.metadata.inputtemplate
   inputfilepath = str(inputfile)
   clam.common.status.write(statusfile, inputfilepath)
   clam.common.status.write(statusfile, os.path.basename(inputfilepath))
   copyfile(inputfilepath, os.path.join(outputdir, os.path.basename(inputfilepath)))
   copyfile(inputfilepath, os.path.join(os.path.join(outputdir, 'test-dir'), os.path.basename(inputfilepath)))
